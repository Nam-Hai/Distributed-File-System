...
log-structured file system discussed [here](/doc/file-lfs.pdf)
[(alternate_url)](https://pages.cs.wisc.edu/~remzi/OSTEP/file-lfs.pdf). On-disk,
...
so. Read [this chapter](/doc/dist-nfs.pdf) [(alternate_url)](https://pages.cs.wisc.edu/~remzi/OSTEP/dist-nfs.pdf) on NFS
for details. 
...
Read these:
- [Log-structured File System](/doc/file-lfs.pdf) [(alternate_url)](https://pages.cs.wisc.edu/~remzi/OSTEP/file-lfs.pdf)
- [Distributed Systems](/doc/dist-intro.pdf) [(alternate_url)](https://pages.cs.wisc.edu/~remzi/OSTEP/dist-intro.pdf)
- [Distributed File System: NFS](/doc/dist-nfs.pdf) [(alternate_url)](https://pages.cs.wisc.edu/~remzi/OSTEP/dist-nfs.pdf)


## Some Helper Code

To get you going, we have written some simple UDP code that can send a
message and then receive a reply from a client to a server. It can be found in [here](/dist-intro) 
[(or here)](https://github.com/remzi-arpacidusseau/ostep-code/tree/master/dist-intro).

You'll also have to learn how to make a shared library. Read  [here](/doc/shared-libraries.html) [(or here)](https://tldp.org/HOWTO/Program-Library-HOWTO/shared-libraries.html) for more information.
